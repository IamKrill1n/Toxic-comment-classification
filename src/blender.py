#source: https://www.kaggle.com/code/reppic/lazy-ensembling-algorithm/notebook
import pandas as pd
import numpy as np
import os
...
ens_submission = pd.read_csv('kaggle/input/jigsaw-toxic-comment-classification-challenge/sample_submission.csv.zip').sort_values('id')
