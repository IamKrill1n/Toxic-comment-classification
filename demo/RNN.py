...
class RNN:
    def __init__(self, model_path = 'model_checkpoint/rnn/glove50_lstm.keras', tokenizer_path = 'model_checkpoint/rnntokenizer.json'):
...
if __name__ == "__main__":
    model = RNN('model_checkpoint/rnn/glove50_lstm.keras')
    while True:
        query = str(input('>>> '))
