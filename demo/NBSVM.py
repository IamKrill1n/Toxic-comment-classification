...
class NBSVM:
    def __init__(self) -> None:
        self.char_vectorizer = load('model_checkpoint/nb_Svm/char_vectorizer.bin')
        self.word_vectorizer = load('model_checkpoint/nb_Svm/word_vectorizer.bin')
        self.loaded_models = []
        for i in range(6):
            self.loaded_models.append(load('model_checkpoint/nb_Svm/nb_Svm_%d.bin' % i))
